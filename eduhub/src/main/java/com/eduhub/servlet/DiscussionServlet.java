...
import com.eduhub.dao.Discussioninsert;
...
public class DiscussionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DiscussionQuiz dsq1 = new DiscussionQuiz(question, usr.getName());
            Discussioninsert ins1 = new Discussioninsert(ConnectionProvider.getConnection());
            if (ins1.savequestion(dsq1)) {
